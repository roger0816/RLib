...
void CTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CTcpServer::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CTcpServer::signalLog)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CTcpServer::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CTcpServer::signalReadAll)) {
                *result = 1;
                return;
            }
        }
